...
import { particleColor, probabilityFlow, fieldColor } from './physics.js';
...
/* ════════════════════════════════════════════════════════════
   PHYSICS — moved to ./physics.js (pure wavefunction math + colors)
   radialR, legendrePlm, particleColor, probabilityFlow, fieldColor
   CDF samplers — moved to ./cdf.js
   buildRadialCDF, buildThetaCDF, sampleCDF   (imported at top)
   ════════════════════════════════════════════════════════════ */

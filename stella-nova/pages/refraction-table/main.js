// ============================================================================
//  REFRACTION TABLE  ·  main.js — data load and boot (the entry module)
// ────────────────────────────────────────────────────────────────────────────
//  Fetch the WGSL pack, the noise pack and the spec. Hand them to the shared
//  table-engine with this page's PAGE object. The engine builds the sidebar and
//  the frame loop. page.js owns the GPU work.
//
//  MODULE MAP
...
bootTable(PAGE, { spec, pack: SH['shaders/pack.wgsl'], aux: { noisePack: SH['shaders/noise.wgsl'] } });

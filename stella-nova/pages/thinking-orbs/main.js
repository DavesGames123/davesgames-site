// ============================================================================
//  THINKING ORBS  ·  main.js — data load and boot (the entry module)
// ────────────────────────────────────────────────────────────────────────────
//  Fetch the WGSL pack and the spec. Hand them to the shared table-engine with
//  this page's PAGE object. The engine builds the sidebar and the frame loop.
//  page.js owns the GPU work. This page uses no noise pack.
//
//  MODULE MAP
...
//      shaders/pack.wgsl .......... the WGSL pack (dot modes as instanced sprites)
// ============================================================================
